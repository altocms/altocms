...
class ActionFilter extends Action {
	...
	protected function EventShowTopics() {
		 ...
		 */
		$aResult=$this->Topic_GetTopicsByType($iPage,Config::Get('module.topic.per_page'),$this->oType->getContentUrl());
		$aTopics=$aResult['collection'];
		/**
		 * Формируем постраничность
		 */
		$aPaging=$this->Viewer_MakePaging($aResult['count'],$iPage,Config::Get('module.topic.per_page'),Config::Get('pagination.pages.count'),Router::GetPath('filter').$this->sCurrentEvent);
		/**
