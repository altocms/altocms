...
class ModuleComment extends Module {
    ...
    {
        if (!is_array($aTargetsId)) $aTargetsId = array($aTargetsId);
        ...
        if (Config::Get('sys.cache.solid')) {
            foreach ($aTargetsId as $nTargetId) {
                $this->Cache_Clean(Zend_Cache::CLEANING_MODE_MATCHING_TAG, array("comment_update", "comment_target_{$nTargetId}_{$sTargetType}"));
            }
        } else {
            foreach ($aTargetsId as $nTargetId) {
                $this->Cache_Clean(Zend_Cache::CLEANING_MODE_MATCHING_TAG, array("comment_target_{$nTargetId}_{$sTargetType}"));
            }
