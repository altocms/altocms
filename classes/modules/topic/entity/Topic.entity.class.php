...
class ModuleTopic_EntityTopic extends Entity {
	...
	public function Init() {
		...
		$this->aValidateRules[]=array('question_title','string','max'=>200,'min'=>2,'allowEmpty'=>true,'label'=>$this->Lang_Get('topic_create_question_title'),'on'=>array('topic'));
		...
		$this->aValidateRules[]=array('topic_tags','tags','count'=>15,'label'=>$this->Lang_Get('topic_create_tags'),'allowEmpty'=>Config::Get('module.topic.allow_empty_tags'),'on'=>array('topic'));
		...
		$this->aValidateRules[]=array('link_url','url','allowEmpty'=>true,'label'=>$this->Lang_Get('topic_link_create_url'),'on'=>array('topic'));
	}
	/**
	...
	public function getFile($id){
		if($this->getField($id)){
			return Engine::GetEntity('ModuleTopic_EntityTopicFile',  unserialize($this->getField($id)->getValueSource()));
		}
		return null;
	}
