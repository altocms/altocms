...
class ModuleBlog extends Module {
	...
	public function GetBlogUsersByUserId($sUserId,$iRole=null,$bReturnIdOnly=false) {
		...
		if (false === ($data = $this->Cache_Get($sCacheKey))) {
			...
			$this->Cache_Set($data, $sCacheKey, array('blog_update', "blog_relation_change_{$sUserId}"), 60*60*24*3);
		}
		/**
    ...
    public function DeleteBlog($aBlogsId)
    {
        ...
        $this->Cache_Clean(
            ...
            array(
                'blog_update', 'topic_update', 'comment_online_update_topic', 'comment_update'
            )
        );
