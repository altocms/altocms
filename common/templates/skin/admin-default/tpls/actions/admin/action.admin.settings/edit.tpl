...
<div class="form-group">
  <label class="col-sm-3 control-label">{$aLang.action.admin.set_view_wysiwyg}</label>
  <div class="col-sm-2">
    <label>
...
<div class="form-group">
  <label class="col-sm-3 control-label">{$aLang.action.admin.set_view_noindex}</label>
  <div class="col-sm-2">
    <label>
...
<div class="form-group">
  <label class="col-sm-3 control-label">{$aLang.action.admin.set_view_img_resize_width}</label>
  <div class="col-sm-2">
...
<div class="form-group">
  <label class="col-sm-3 control-label">{$aLang.action.admin.set_view_img_max_width}</label>
  <div class="col-sm-2">
    <div class="input-group">
...
<div class="form-group">
  <label class="col-sm-3 control-label">{$aLang.action.admin.set_view_img_max_height}</label>
  <div class="col-sm-2">
    <div class="input-group">
...
<div class="form-group">
  <label class="col-sm-3 control-label">{$aLang.action.admin.set_topic_max_height}</label>
  <div class="col-sm-2">
    <div class="input-group">
...
<div class="form-group">
  <label class="col-sm-3 control-label">{$aLang.action.admin.set_topic_tag_required}</label>
  <div class="col-sm-2">
    <label>
...
<div class="form-group">
  ...
  <label class="col-sm-3 control-label">{$aLang.action.admin.set_edit_comment}</label>
