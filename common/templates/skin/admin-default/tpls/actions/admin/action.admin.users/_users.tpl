...
{block name="content-body"}
  ...
  <div class="col-md-3">
    ...
    <div class="panel panel-default noborder" id="user-comands-switch">
      ...
      <div class="panel-body">
        ...
        <div class="collapse" id="admin_user_ban">
          <form method="post" action="{$sFormAction}" class="well-well-small">
            ...
            <input type="text" class="form-control" name="ban_comment" id="ban_comment" maxlength="255" class="input-wide"/>
            <input type="hidden" name="return-path" value="{Router::Url('url')}"/>
      ...
      <div class="panel-body">
        ...
        <div class="panel-body {if !$aFilter}collapse{/if} collapse-save" id="admin_form_seek">
          <form method="post" action="{router page='admin'}users-list/" class="well-well-small" id="user_filter_form">
            ...
            <div class="input-group {if $aFilter.login}success{/if}">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="user_filter_login" id="user_filter_login" value="{$aFilter.login}" class="wide js-autocomplete-users"/>
              </div>
            </div>
            <div class="input-group {if $aFilter.email}success{/if}">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" name="user_filter_email" id="user_filter_email" value="{$aFilter.email}" class="wide"/>
              </div>
            ...
            <div class="input-group {if $aFilter.regdate}success{/if}">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control datepicker" name="user_filter_regdate" id="user_filter_regdate" value="{$aFilter.regdate}" class="wide"/>
              </div>
      ...
      <div class="panel-body" style="display: none;">
        ...
        <div class="collapse" id="admin_form_send">
          <form method="post" action="" class="well-well-small">
            ...
            <div class="input-group">
              <label>
              <input class="form-control" class="form-control" type="radio" name="send_common_message" id="send_common_message_yes" value="yes"
                onclick="AdminMessageSeparate(this.checked)"/>
              {$aLang.action.admin.send_common_message}
              </label>
              <label>
              <input class="form-control" type="radio" name="send_common_message" id="send_common_message_no" value="no"
                checked
                onclick="AdminMessageSeparate(!this.checked)"/>
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" name="talk_title" id="talk_title" maxlength="30" class="wide"/>
            </div>
            <div class="input-group">
          ...
          <form method="post" action="{router page='admin'}users-list/">
            ...
            <div class="well-well-small">
              <div class="input-group">
                ...
                <div class="input-group">
                  <span class="input-group-addon"><i class="ion-android-contact"></i></span>
                  <input type="text" class="form-control" name="user_login_admin" id="user_login_admin" class="wide users_list js-autocomplete-users"/>
                </div>
              </div>
            </div>
          </form>
