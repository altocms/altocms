...
<div class="col-md-12">
  <form method="post" action="" class="form-horizontal">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="form-group">
          <label for="adm_cache_clear_data" class="col-sm-3 control-label">{$aLang.action.admin.cache_clear_data}</label>
          <div class="col-sm-9">
          ...
          <label for="adm_cache_clear_assets" class="col-sm-3 control-label">{$aLang.action.admin.cache_clear_assets}</label>
          <div class="col-sm-9">
            ...
            <label for="adm_cache_clear_smarty" class="col-sm-3 control-label">{$aLang.action.admin.cache_clear_smarty}</label>
          <div class="col-sm-9">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="form-group">
            <label for="adm_reset_config_data" class="col-sm-3 control-label">{$aLang.action.admin.reset_config_data}</label>
          <div class="col-sm-9">
