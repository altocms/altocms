<div class="popover-user-info-container">
    ...
    <div class="popover-user-info-content">
        <ul class="popover-user-info-top">
            ...
            {/if}
            <li class="user-info-default-rss"><a href="{R::GetLink("rss")}personal_blog/{$oUser->getLogin()}/"><i class="fa fa-rss"></i></a></li>
        ...
        <ul class="popover-user-info-bottom">
            {if E::User() && $oUser->getId() != E::User()->getId()}
                <li>
                    <a href="{R::GetLink("talk")}add/?talk_users={$oUser->getLogin()}"
