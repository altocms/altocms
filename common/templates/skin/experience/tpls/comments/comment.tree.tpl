...
{else}
    {if E::IsUser()}
        ...
        <div class="topic-comment-controls reply-header" id="comment_id_0">
            ...
            <a class="btn btn-light btn-big corner-no pull-right"
            ...
            <form method="post" class="comment-reply js-form-comment" onsubmit="return false;" enctype="multipart/form-data">
                ...
                <button type="button" onclick="ls.comments.formCommentHide();"
                        class="btn btn-light btn-big corner-no pull-right js-button-cancel">{$aLang.text_cancel}</button>
                <button type="submit" name="submit_comment"
                        id="comment-button-submit"
                        onclick="ls.comments.add(this,'{$iTargetId}','{$sTargetType}'); return false;"
                        class="btn btn-blue btn-big corner-no js-button-submit">{$aLang.text_send}</button>
                <button type="submit" name="edit_comment"
                        ...
                        class="btn btn-blue btn-big corner-no btn-edit js-button-edit" style="display: none;">
                    {$aLang.comment_edit_submit}
                </button>
                <button type="button" onclick="ls.comments.preview();"
                        class="btn btn-light btn-big corner-no js-button-preview">{$aLang.comment_preview}</button>
            </form>
