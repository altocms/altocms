...
<script type="text/template" class="js-alto-topic-uploader-template">
    {var name="sTemplate"}
    <div class="col-md-24 mab6" id="uploader_item_ID">
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="js-alto-topic-uploader-form clearfix">
                        ...
                        {literal}
                            <div class="js-files-tpl row">
                                <div class="js-topic-file-tpl js-autoremove col-md-24" data-id="<%=uid%>" title="<%-name%>, <%-sizeText%>">
                                    <div class="row">
                                        <div class="col-md-4">
