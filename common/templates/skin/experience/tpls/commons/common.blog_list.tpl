                    ...
                    <div class="blog-logo">
                        {if Router::GetActionEvent()=='personal'}
                            <a href="{$oUserOwner->getProfileUrl()}">
                                <img src="{$oUserOwner->getAvatarUrl(48)}" alt="{$oUserOwner->getDisplayName()}"/>
                            </a>
                        {else}
                            {$sBlogAvatar = $oBlog->getUrlFull()}
                            {if $sBlogAvatar}
                            <a href="{$oBlog->getUrlFull()}">
                                <img src="{$oBlog->getAvatarPath(48)}" width="48" height="48" class="avatar"/>
                            </a>
                            {else}
                    ...
                    <div class="blog-more">
                        ...
                        <i class="fa fa-caret-down" data-toggle="tooltip" data-placement="bottom" data-original-title='
                                                ...
                                                <dl class="dl-horizontal">
                                                    ...
                                                    <dt>{$aLang.infobox_blog_rating}:</dt><dd>{$oBlog->getRating()}</dd>
                                                </dl>
