...
<div class="add-photo">
    ...
    <div style="display: {if count($aPhotos)}block{else}none{/if};" class="img-container">
        <div class="bg-warning tags-about">
        ...
        <div>
            ...
            <ul id="swfu_images" class="list-unstyled">
                {if count($aPhotos)}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-20">
                                    ...
                                    <a href="#"
                                       ...
                                       class="link link-lead link-red-blue"><i class="fa fa-times"></i>&nbsp;{$aLang.topic_photoset_photo_delete}</a>
                                    ...
                                    {else}
                                        <a href="#" onclick="ls.photoset.setPreview('{$oPhoto->getId()}'); return false;"
                                           class="link link-lead link-blue">{$aLang.topic_photoset_mark_as_preview}</a>
                                    {/if}
                                    </span>
                                </div>
                            </div>
        ...
        <div>
            ...
            <a href="#" id="photoset-upload-button"
               ...
               class="link link-lead link-blue openimage-link">
                <i class="fa fa-plus"></i>{$aLang.topic_photoset_upload_choose}
            </a>
        </div>
