...
<div class="row">
    ...
    <form action="{router page='login'}reactivation/" method="POST" id="reactivation-form">
        ...
        <button type="submit" name="submit_reactivation" class="btn btn-blue btn-big corner-no" id="reactivation-form-submit" disabled="disabled">{$aLang.reactivation_submit}</button>
    </form>
    </div>
</div>
