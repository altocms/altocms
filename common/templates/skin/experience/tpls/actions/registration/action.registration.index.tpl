...
<div class="row">
    ...
    <form action="{router page='registration'}" method="post" id="registration-form" class="js-form-registration">
        ...
        <a class="btn btn-light btn-big corner-no" href="{router page='login'}">{$aLang.user_login_submit}</a>
        <button type="submit" name="submit_register" id="registration-form-submit" class="btn btn-blue btn-big corner-no js-form-registration-submit" disabled="disabled">
