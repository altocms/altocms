 ...
 {block name="layout_content"}
         ...
         <div class="panel-body">
             ...
             <div class="row user-info-block">
                 <div class="col-lg-20">
                     ...
                     <img class="user-logo" src="{$oBlog->getAvatarPath(85)}" alt="avatar"/>
                     <div class="user-name">
                                    ...
                                    <a href="{$oUserOwner->getProfileUrl()}">{$oUserOwner->getDisplayName()}</a>
                                     ...
                                     {if $aBlogAdministrators}
                                         {foreach $aBlogAdministrators as $oBlogUser}
                                            ...
                                            <a class="link link-clear" href="{$oUser->getProfileUrl()}"><img src="{$oUser->getAvatarUrl(24)}" alt="avatar"/></a>
     ...
     <div class="user-toggle-publication-block">
         ...
         <div class="inb outline-no dropdown {if $sMenuSubItemSelect=='discussed'} active{/if}">
             <a href="{$sMenuSubBlogUrl}discussed/" class="outline-no btn btn-light-gray dropdown-toggle {if $sMenuSubItemSelect=='discussed'} active{/if}" data-toggle="dropdown">
