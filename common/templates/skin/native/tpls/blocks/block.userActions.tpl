...
{block name='block_content'}
	...
	<ul class="profile-actions" id="profile_actions">
		...
		<li><a href="{router page='talk'}add/?talk_users={$oUserProfile->getLogin()}"><i class="icon-native-profile-new-talk"></i>{$aLang.user_write_prvmsg}</a></li>						
		<li>
			<a href="#" onclick="ls.user.followToggle(this, {$oUserProfile->getId()}); return false;" class="follow-link {if $oUserProfile->isFollow()}followed{/if}">
