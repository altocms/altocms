        ...
        <div class="stream-settings-userlist">
            <div class="search-form">
                <div class="search-form-search">
                    <input type="text" id="userfeed-block-users-input" autocomplete="off"
                           placeholder="{$aLang.userfeed_block_users_append}"
                           class="search-form-input autocomplete-users width-full"/>
