	...
	<div class="profile-wrapper">
		{if $oUserCurrent}
			<form class="wall-submit">
				...
				<button type="button" onclick="ls.wall.add(jQuery('#wall-text').val(),0);" class="btn-primary js-button-wall-submit">{$aLang.wall_add_submit}</button>
			</form>
		{else}
		...
		<div id="wall-container" class="comments wall nopad">
