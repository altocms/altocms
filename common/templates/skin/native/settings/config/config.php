...
$config['head']['default']['js'] = array(
    ...
    '___path.frontend.dir___/libs/js/vendor/jquery-migrate-1.2.1.js' => array('asset' => 'mini'),
    ...
    */
    ...
    '___path.skin.dir___/assets/js/init.js',
);
...
$config['head']['default']['css'] = array_merge(
    ...
    array(
         ...
         '___path.frontend.dir___/libs/js/vendor/jquery-ui/css/smoothness/jquery-ui-1.10.2.custom.css',
         ...
         '___path.frontend.dir___/libs/js/vendor/prettyphoto/css/prettyphoto.css',
         '___path.frontend.dir___/libs/js/vendor/notifier/jquery.notifier.css',
         '___path.frontend.dir___/libs/js/vendor/tinymce_4/plugins/altoimage/css/style.css',

         '___path.skin.dir___/assets/css/grid.css',
         '___path.skin.dir___/assets/css/forms.css',
         '___path.skin.dir___/assets/css/buttons.css',
         '___path.skin.dir___/assets/css/common.css',
         '___path.skin.dir___/assets/css/icons.css',
         '___path.skin.dir___/assets/css/navs.css',
         '___path.skin.dir___/assets/css/tooltip.css',
