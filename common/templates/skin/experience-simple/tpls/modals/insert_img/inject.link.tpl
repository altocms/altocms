    ...
    <form method="POST" action="" enctype="multipart/form-data" onsubmit="return false;">
        ...
        <div class="clearfix text-right">
            {if C::Get('module.topic.external_img') == 1}
                <button type="submit" class="btn btn-light btn-normal corner-no js-aim-btn-insert-link">
                    {$aLang.uploadimg_link_submit_paste}
                </button>
                &nbsp;{$aLang._or}&nbsp;
            {/if}
            <button type="submit" class="js-aim-btn-upload-image btn btn-blue btn-normal corner-no  js-aim-btn-upload-image">
