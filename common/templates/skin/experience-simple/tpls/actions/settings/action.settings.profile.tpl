            ...
            <form method="post" enctype="multipart/form-data" class="form-profile">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class              ="js-alto-uploader tac settings-avatar-change"
                             ...
                             data-aspect-ratio  = "{C::Get('module.uploader.images.profile_avatar.transform.aspect_ratio')}"
                ...
                <div class="mab12">
                    ...
                    {if $aUserFieldsContact}
                        <button class="btn btn-light btn-normal corner-no" onclick="return ls.userfield.addFormField();">
                ...
                <button type="submit" name="submit_profile_edit" class="btn btn-blue btn-normal corner-no mat8">
