...
<div class="panel panel-default panel-table flat">
    ...
    <div class="panel-body">
        ...
        <form action="" method="POST" enctype="multipart/form-data" class="wrapper-content">
            ...
            <button type="submit" class="btn btn-blue btn-normal corner-no pull-right" name="submit_talk_add">{$aLang.talk_create_submit}</button>
            <button type="submit" class="btn btn-light btn-normal corner-no" name="submit_preview"
