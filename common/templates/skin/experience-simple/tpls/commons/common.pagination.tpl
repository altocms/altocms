    ...
    <div class="paginator">
        <ul class="js-pagination">
            ...
            {foreach $aPaging.aPagesLeft as $iPage}
                <li><a class="" href="{$aPaging.sBaseUrl}/page{$iPage}/{$aPaging.sGetParams}">{$iPage}</a></li>
            {/foreach}
            ...
            {if $aPaging.iCurrentPage<$aPaging.iCountPage}
                <li class="last"><a  class=""  href="{$aPaging.sBaseUrl}/page{$aPaging.iCountPage}/{$aPaging.sGetParams}"
