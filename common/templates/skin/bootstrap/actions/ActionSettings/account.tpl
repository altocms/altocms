...
<form method="post" enctype="multipart/form-data">
    ...
    <fieldset>
        ...
        <dl class="form-item">
            ...
            <dd>
                <input type="email" name="mail" id="mail" value="{$oUserCurrent->getMail()|escape:'html'}"
    ...
    <fieldset>
        ...
        <dl class="form-item">
            ...
            <dd><input type="password" name="password_now" id="password_now" value=""
                       class="input-text input-width-200"/></dd>
        </dl>
        ...
        <dl class="form-item">
            ...
            <dd><input type="password" id="password_confirm" name="password_confirm" value=""
                       class="input-text input-width-200"/></dd>
        </dl>
    </fieldset>
    ...
    <button type="submit" name="submit_account_edit" class="btn btn-primary"/>
