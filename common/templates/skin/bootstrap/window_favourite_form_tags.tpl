{if $oUserCurrent}
    <div id="favourite-form-tags" class="modal">
        ...
        <form onsubmit="return ls.favourite.saveTags(this);" class="modal-content">
            ...
            <p><input type="text" name="tags" value="" id="favourite-form-tags-tags"
                      class="autocomplete-tags-sep input-text input-width-full"></p>
            <button type="submit" name="" class="btn btn-primary"/>
            {$aLang.favourite_form_tags_button_save}</button>
            <button type="submit" name="" class="btn jqmClose"/>
