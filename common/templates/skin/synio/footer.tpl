    ...
    <footer id="footer">
        ...
        {else}
            <ul class="footer-list">
                ...
                <li><a href="{router page='login'}" class="js-login-form-show sign-in">{$aLang.user_login_submit}</a>
                </li>
		...
		*}
        ...
        <div class="copyright">
            ...
            <div class="design-by">
                <img src="{Config::Get('path.skin.assets.url')}images/xeoart.png" alt="xeoart"/>
