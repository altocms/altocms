...
<form action="{router page='registration'}" method="post" id="registration-form" class="registration-form">
    <div class="wrapper-content">
        ...
        <dl class="form-item">
            ...
            <dd>
                <input type="text" name="login" id="registration-login" value="{$_aRequest.login}"
        ...
        <dl class="form-item">
            ...
            <dd>
                <input type="text" name="mail" id="registration-mail" value="{$_aRequest.mail}"
                       class="input-text input-width-250 js-ajax-validate"/>
        ...
        <dl class="form-item">
            ...
            <dd>
                <input type="password" name="password" id="registration-user-password" value=""
                       class="input-text input-width-250 js-ajax-validate"/>
        ...
        <dl class="form-item">
            ...
            <dd>
                <input type="password" value="" id="registration-user-password-confirm" name="password_confirm"
                       class="input-text input-width-250 js-ajax-validate"/>
    ...
    <div class="wrapper-content">
        <dl class="form-item">
            <dt></dt>
            <dd>
                <button type="submit" name="submit_register" class="button button-primary" id="registration-form-submit"
