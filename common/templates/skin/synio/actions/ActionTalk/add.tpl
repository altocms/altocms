...
<form action="" method="POST" enctype="multipart/form-data">
    ...
    <p>
        ...
        <input type="text" class="input-text input-width-full" id="talk_title" name="talk_title" value="{$_aRequest.talk_title}"/>
    </p>
    ...
    <button type="submit" class="button button-primary" name="submit_talk_add">
        {$aLang.talk_create_submit}
    </button>
    <button type="submit" class="button" name="submit_preview" onclick="jQuery('#text_preview').parent().show(); ls.tools.textPreview('talk_text',false); return false;">
