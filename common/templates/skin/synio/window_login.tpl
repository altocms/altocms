    ...
    <div class="modal modal-login" id="window_login_form">
        ...
        <div class="modal-content">
            <ul class="nav nav-pills nav-pills-tabs">
                ...
                {else}
                    <li>
                        <a href="{router page='registration'}">{$aLang.registration}</a>
                    </li>
                {/if}
                <li class="js-block-popup-login-item" data-type="reminder">
                    <a href="#">{$aLang.password_reminder}</a>
                </li>
            </ul>
            ...
            <div class="tab-content js-block-popup-login-content" data-type="login">
                ...
                <form action="{router page='login'}" method="post" id="popup-login-form">
                    ...
                    <p>
                        <input type="text" name="login" id="popup-login" placeholder="{$aLang.user_login}"
                               class="input-text input-width-full">
                    </p>

                    <p>
                        <input type="password" name="password" id="popup-password" placeholder="{$aLang.user_password}"
                               class="input-text input-width-300" style="width: 322px">
                        <button type="submit" name="submit_login" class="button button-primary"
                                id="popup-login-form-submit" disabled="disabled">
                            {$aLang.user_login_submit}
                        </button>
                    </p>

                    <label class="remember-label">
                        <input type="checkbox" name="remember" class="input-checkbox" checked/>
                        {$aLang.user_login_remember}
                    </label>
            ...
            <div data-type="registration" class="tab-content js-block-popup-login-content" style="display:none;">
                ...
                <form action="{router page='registration'}" method="post" id="popup-registration-form">
                    ...
                    <p>
                        <input type="text" name="login" placeholder="{$aLang.registration_login}"
                               id="popup-registration-login" value="{$_aRequest.login}"
                    ...
                    <p>
                        <input type="text" name="mail" placeholder="{$aLang.registration_mail}"
                               id="popup-registration-mail" value="{$_aRequest.mail}"
                               class="input-text input-width-300 js-ajax-validate"/>
                    ...
                    <p>
                        <input type="password" name="password" placeholder="{$aLang.registration_password}"
                               id="popup-registration-user-password" value=""
                               class="input-text input-width-300 js-ajax-validate"/>
                    ...
                    <p>
                        <input type="password" name="password_confirm"
                               placeholder="{$aLang.registration_password_retry}"
                               id="popup-registration-user-password-confirm" value=""
                               class="input-text input-width-300 js-ajax-validate"/>
                    ...
                    <input type="hidden" name="return-path" value="{$PATH_WEB_CURRENT|escape:'html'}">
                    <button type="submit" name="submit_register" class="button button-primary"
                            id="popup-registration-form-submit" disabled="disabled">
            ...
            <div data-type="reminder" class="tab-content js-block-popup-login-content" style="display:none;">
                ...
                <form action="{router page='login'}reminder/" method="POST" id="popup-reminder-form">
                    <p>
                        <input type="text" name="mail" placeholder="{$aLang.password_reminder_email}"
                               id="popup-reminder-mail" class="input-text input-width-300"/>
                        <small class="validate-error-hide validate-error-reminder"></small>
                    </p>

                    <button type="submit" name="submit_reminder" class="button button-primary"
                            id="popup-reminder-form-submit" disabled="disabled">
