                    ...
                    <ul class="list-unstyled list-inline modal-write-list">
                        {if $iUserCurrentCountTopicDraft}
                            <li class="write-item-type-draft">
                                <a href="{R::GetLink("content")}drafts/" class="write-item-image"></a>
                                <a href="{R::GetLink("content")}drafts/" class="write-item-link">{$iUserCurrentCountTopicDraft} {$iUserCurrentCountTopicDraft|declension:$aLang.draft_declension:$sLang}</a>
                            </li>
                        {/if}
