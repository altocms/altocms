...
ls.settings = (function ($) {
    ...
    this.presets.tinymce['default'] = function(){
        return {
            ...
            plugins: "advlist autolink autosave link lists media pagebreak autoresize table code altoimage snippets photoset username",
            //convert_urls: false,
            extended_valid_elements: "embed[src|type|allowscriptaccess|allowfullscreen|width|height],alto[from|to|style|position|topic],alto:photoset[from|to|style|position|topic],alto:user[login|style|conteneditable]",
