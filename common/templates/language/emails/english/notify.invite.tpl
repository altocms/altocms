The user <a href="{$oUserFrom->getUserWebPath()}">{$oUserFrom->getLogin()}</a> invited you to register on the site <a href="{Config::Get('path.root.url')}">{Config::Get('view.name')}</a><br>
