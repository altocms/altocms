...
class PluginLs_ActionContent extends PluginLs_Inherits_ActionContent {
    ...
    protected function EventEdit() {
        ...
        $_REQUEST['topic_link_url'] = $_REQUEST['topic_field_link'];
        $_REQUEST['topic_tags'] = $_REQUEST['topic_field_tags'];
        $_REQUEST['question_title'] = $_REQUEST['topic_field_question'];
        $_REQUEST['answer'] = $_REQUEST['topic_field_answers'];
        return parent::SubmitAdd();
    }
