...
$config['ls']['head']['default']['js']  = array(
    ...
    '___path.frontend.dir___/libs/js/vendor/jquery.rich-array.min.js' => array('asset' => 'mini'),
    '___path.frontend.dir___/libs/js/vendor/jquery.placeholder.min.js' => array('asset' => 'mini'),
