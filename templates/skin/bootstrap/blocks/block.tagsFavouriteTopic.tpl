<section class="block block-type-foldable block-type-favourite-topic">
	<header class="block-header">
		<h3><a href="#" class="link-dotted" onclick="jQuery('#block_favourite_topic_content').toggle(); return false;"><i class="icon-arrow-down icon-white"></i>{$aLang.topic_favourite_tags_block}</a></h3>
	</header>
