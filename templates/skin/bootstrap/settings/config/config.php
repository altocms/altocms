 ...
 * Закрепление панелей
 *
 * fixed - закрепляем панель
 * nofixed - откпреляем панель
 *
 * top_panel - верхняя панель
 * main_menu - главное меню
 */
$config['view']['top_panel']['type'] = 'fixed';
$config['view']['main_menu']['type'] = 'fixed';

/*
 * Голосование плюс/минус
 *
 * plus_minus - слева плюс, справа минус
 * minus_plus - слева минкс, справа плюс
 *
 * vote_profile - в профиле
 * vote_comments - в комментариях
 * vote_topic - в топике
 * vote_blog - в блоге
 */
...
$config['head']['default']['js'][] = '___path.static.skin___/themes/default/js/bootstrap.js';
$config['head']['default']['js'][] = '___path.static.skin___/themes/default/js/bootswatch.js';
