...
<form method="post" enctype="multipart/form-data" class="form-profile">
	...
	<fieldset>
		...
		<dl class="form-item">
			...
			<dd>
				<select name="profile_birthday_day" class="input-width-300">
				...
				<select name="profile_birthday_month" class="input-width-300">
				...
				<select name="profile_birthday_year" class="input-width-300">
	...
	<fieldset class="contact-contener">
		...
		{if $aUserFieldsContact}
			<a href="#" onclick="return ls.userfield.addFormField();" class="btn btn-primary"><i class="icon-hand-up icon-white"></i>{$aLang.user_field_add}</a>
		{/if}
	</fieldset>
