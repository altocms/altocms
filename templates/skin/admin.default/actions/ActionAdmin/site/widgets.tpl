                            ...
                            <tr id="widget-{$oWidget->GetId()}" class="selectable {$sClass}">
                                ...
                                <td class="center">
                                    <div class="b-switch"
                                        ...
                                        <input type="checkbox" {if $oWidget->isActive()}checked{/if} name="b-switch-{$oWidget->GetId()}">
                                        <label><i></i></label>
                                    </div>
                                </td>
                                <td class="center">
                                    <a href="{router page="admin"}widgets/edit/{$oWidget->GetId()}"><i class="icon-edit"></i></a>
                                </td>
                            </tr>
                        {/foreach}
                        </tbody>
