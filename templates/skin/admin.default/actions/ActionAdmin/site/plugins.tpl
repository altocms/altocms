...
{block name="content-body"}
    <div class="span12">
        <div class="btn-group">
            <a href="{router page='admin'}plugins/add/" class="btn btn-primary tip-top"
        ...
        <form action="{router page='admin'}plugins/" method="post" id="form_plugins_list" class="uniform">
                            ...
                            <tr id="plugin-{$oPlugin->GetId()}"
                                ...
                                <td class="action">
                                    <div class="b-switch"
                                        ...
                                        <input type="checkbox" {if $oPlugin->isActive()}checked{/if} name="b-switch-{$oPlugin->GetId()}">
                                        <label><i></i></label>
                                    </div>
                                </td>
                                <td class="center">
