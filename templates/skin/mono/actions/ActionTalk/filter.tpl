<section class="b-widget block-type-foldable block-type-talk-search">
	...
	<div class="b-widget-content" id="block_talk_search_content" {if $_aRequest.submit_talk_filter}style="display:block;" {/if}>
