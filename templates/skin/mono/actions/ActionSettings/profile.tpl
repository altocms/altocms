...
<form method="post" enctype="multipart/form-data" class="form-profile">
	...
	<fieldset>
		...
		<dl class="form-item">
			<dt><label>{$aLang.settings_profile_birthday}:</label></dt>
			<dd>
		...
		<dl class="form-item js-geo-select">
			<dt><label>{$aLang.profile_place}:</label></dt>
			<dd>
				<p>
	...
	<button type="submit" name="submit_profile_edit" class="btn-primary" />{$aLang.settings_profile_submit}</button>
</form>
