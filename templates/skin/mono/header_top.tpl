<nav id="userbar" class="b-userbar i-container clearfix">
	...
	<ul class="b-nav-userbar">
		{if $oUserCurrent}
			...
			<li><a href="{router page='content'}add/" class="write" id="modal_write_show">{$aLang.block_create}</a></li>
...
<header id="header" role="banner" class="b-header">
	{hook run='header_banner_begin'}
	<hgroup class="b-site-info">
		<h1 class="b-site-name"><a href="{cfg name='path.root.web'}">{cfg name='view.name'}</a></h1>
		<h2 class="b-site-description">{cfg name='view.description'}</h2>
	</hgroup>
