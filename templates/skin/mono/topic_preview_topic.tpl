...
<button type="submit" name="submit_preview" onclick="jQuery('#text_preview').html('').hide(); return false;" class="btn fl-r">{$aLang.topic_create_submit_preview_close}</button>
...
<button type="submit" name="submit_topic_publish" class="btn-primary" onclick="jQuery('#submit_topic_publish').trigger('click');">{$aLang.topic_create_submit_publish}</button>
