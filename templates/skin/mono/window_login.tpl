		...
		<div class="b-modal-content">
			...
			<div class="tab-content js-block-popup-login-content" data-type="login">
				...
				<form action="{router page='login'}" method="post" id="popup-login-form">
					...
					<button type="submit" name="submit_login" class="btn-primary" id="popup-login-form-submit" disabled="disabled">{$aLang.user_login_submit}</button>
				</form>
			...
			<div data-type="registration" class="tab-content js-block-popup-login-content" style="display:none;">
				...
				<form action="{router page='registration'}" method="post" id="popup-registration-form">
					...
					<input type="hidden" name="return-path" value="{$PATH_WEB_CURRENT}">
					<button type="submit" name="submit_register" class="btn-primary" id="popup-registration-form-submit" disabled="disabled">{$aLang.registration_submit}</button>
				</form>
			...
			<div data-type="reminder" class="tab-content js-block-popup-login-content" style="display:none;">
				...
				<form action="{router page='login'}reminder/" method="POST" id="popup-reminder-form">
					...
					<button type="submit" name="submit_reminder" class="btn-primary" id="popup-reminder-form-submit" disabled="disabled">{$aLang.password_reminder_submit}</button>
				</form>
			</div>
		</div>
	</div>
