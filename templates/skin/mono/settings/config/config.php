...
$config['view']['theme'] = 'dark-blue';
//$config['view']['theme'] = 'brown';
//$config['view']['theme'] = 'dark-plum';
//$config['view']['theme'] = 'dark-green';

$config['view']['assign'] = array(
...
$config['head']['default']['css'] = array(
	...
	"___path.static.skin___/css/widgets.css",
