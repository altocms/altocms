{wgroup group='toolbar' name='toolbar_comment.tpl' command="add"
...
<div class="comments" id="comments">
	<header class="comments-header -box">
        {if $bAllowSubscribe and $oUserCurrent}
            <div class="subscribe">
                {$aLang.comment_whatch}
                <input {if $oTrackComment and $oTrackComment->getStatus()}checked="checked"{/if} type="checkbox" id="comment_track" class="input-checkbox" onchange="ls.subscribe.tracktoggle('{$sTargetType}_new_comment','{$iTargetId}',this.checked);">
...
{else}
	{if $oUserCurrent}
		...
		<h4 class="reply-header" id="comment_id_0">
			<a href="#" class="link-dotted" onclick="ls.comments.newComment(0); return false;">{$sNoticeCommentAdd}</a>
		</h4>
		...
		<div id="reply" class="reply">
			...
			<form method="post" id="form_comment" onsubmit="return false;" enctype="multipart/form-data">
                ...
                <button type="submit" name="edit_comment"
                        ...
                        class="btn-primary btn-edit" style="display: none;">
